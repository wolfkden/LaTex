...
\begin{definition}{Composition Algebra}\label{def:composition},
  each arrow, $\oarr{n}{r}\in\ccarr{n}{C}$, of a collection, $\parsecat{C}$,
  ...
  \begin{itemize}
    \item\textbf{(Domain)}, $\oarrdom{n}{r}\in\catobj{C}$, domain object
    \item\textbf{(Codomain)}, $\oarrcod{n}{r}\in\catobj{C}$, codomain object
    ...
    \item\textbf{(Composition Algebra)},\\ given arrows,
      $\oarr{n}{r}$,$\oarr{n}{s}$,$\oarr{n}{t}\in\catarr{C}$, where\\
      ...
      \item\textbf{(Associative)}
        $(\oarr{n}{t}\circ\oarr{n}{s})\circ\oarr{n}{r}=\oarr{n}{t}\circ(\oarr{n}{s}\circ\oarr{n}{r})$
      \item\textbf{(Identity)} $\oarrid{n}{o}\in\catarr{C}\quad\forall\;
       \obk{o}\in\catobj{C}$. Identity generalizes to higher orders,
       ...
       identities:
      \begin{itemize}
        \item\textbf{(Idempotency)} $\oarrid{n}{o}\circ\oarrid{n}{o}=\oarrid{n}{o}$
        \item\textbf{(Composition Identity)} $\forall\;\oarr{n}{r}\in\catarr{C}$ \\
        $\oarr{n}{r}=\oarr{n}{r}\circ\oarrid{n}{\oarrdom{n}{r}}=\oarrid{n}{\oarrcod{n}{r}}\circ\oarr{n}{r}$
      \end{itemize}
      \end{itemize}
  \end{itemize}  
\end{definition}
...
$o=\oarrid{n}{o}(\catobj{C})$ when $\obk{o}\in\catobj{C}$,
...
identity arrow, $\oarrid{n}{o}\in\largecatarr$,
...
\begin{definition}{Monomorphism, $\oper{mono}$}\label{prop:monomorphism},
  $\oarr{n}{f}\in\catarr{C}$, of category $\parsecat{C}$,
  is a monomorphism, $\oper{monic}$, \\
  for any $\oarr{n}{g}$,$\oarr{n}{h}\in\catarr{C}$, 
  $\obk{a}=\oarrdom{n}{g}=\oarrdom{n}{h}$ \\
  and $\quad\oarrcod{n}{g}=\oarrcod{n}{h}=\oarrdom{n}{f}$ \\
  $\qquad\Longrightarrow\oarr{n}{f\circ g}=
...
\begin{definition}{Epimorphism, $\oper{epi}$}\label{prop:epimorphism},
  $\oarr{n}{f}\in\catarr{C}$, of category $\cat{C}$,
  is a epimorphism, $\oper{epic}$,
  for any $\oarr{n}{g}$,$\oarr{n}{h}\in\catarr{C}$ \\
  $\obk{b}=\oarrcod{n}{g}=\oarrcod{n}{h}$ \\
...
\begin{definition}{Isomorphism, $\oper{iso}$}
  is a reflexive property of a pair of arrows $\pair{\oarr{n}{r}}{\oarr{n}{r}^{-1}}$
  such that, $\oarr{n}{r^{-1}}=\oarr{n}{r}^{-1}$:
  \begin{itemize}
    \item$\oarrdom{n}{r}=\oarrcod{n}{r^{-1}}$ and $\oarrdom{n}{r^{-1}}=\oarrcod{n}{r}$
...
\begin{definition}{Functor}\label{def:functorarrow},
 ...
 \begin{array}{llll}
  \quad\bullet\textbf{(Object)}&\wrapobj{\functcod{F}}&=&
                             \{\oarr{n}{f}(\obk{o})\hspace{6pt}\mid
                             \oarr{n}{f}\in\functobj{F}, \\[3pt]
   &\hspace{16pt}\oarrdom{n}{f}&=&\obk{o}\in\wrapobj{\functdom{F}}\} \\[3pt]
  \quad\bullet\textbf{(Arrow)}&\wraparr{\functcod{F}}&=& \\[3pt]
   &\{\oarr{2}{f}(\oarr{n}{o})&\mid&\oarr{2}{f}\in\functarr{F}, \\[3pt]
   &\hspace{16pt}\oarrdom{2}{f}&=&\oarr{n}{o}\in\wraparr{\functdom{F}}\} \\[3pt]
  \quad\bullet\textbf{(Identity)}&\hspace{24pt}\{\oarrid{2}{f}&\mid& \\[3pt]
      &\oarrid{2}{f}(\oarr{n}{f})&=&\oarr{n}{f}\,\forall\oarr{n}{f}\infunctobj{F}, \\[3pt]
...
\begin{definition}{Composition Homomorphism}\label{def:functorhomomorphism},
  ...
  $\oarr{n}{g}$, $\oarr{n}{f}\in\wraparr{\functdom{F}}$:
  \begin{equation*}
 \begin{array}{llll}
  \quad\bullet\;\: & \funct{F}(\mapaob{a}{f}{b}}) &=&
    \functV{F}{a}\xrightarrow{\;\functV{F}{f}\;}\functV{F}{b} \\[3pt]
  \quad\bullet\;\: & \funct{F}(\oarrid{n}{a}) &=& \oarrid{n}{\functV{F}{a}} \\[3pt]
  \quad\bullet\;\: & \funct{F}(\oarr{n}{\obk{g}\circ\obk{f}}) &=&
    \oarr{n}{\functV{F}{g}}\circ\oarr{n}{\functV{F}{f}}
    =\oarr{n}{\functV{F}{g}\circ\functV{F}{f}}
 \end{array}
 \end{equation*}
Where, $\functV{F}{a},\,\functV{F}{b}\in\wrapobj{\functcod{F}}$ and \\
       $\functV{F}{f},\,\functV{F}{g},\,\oarr{n}{\functV{F}{g}\circ\functV{F}{f}}\in\wraparr{\functcod{F}}$
\end{definition}
...
\begin{equation*}
 \begin{array}{llll}
  \quad\bullet\;\: & \owraparr{1}{\functid{C}} &=&
                    \{\oarrid{n}{o}\mid\obk{o}\in\ccobj{C}\,\}=\ccid{C} \\[3pt]
  \quad\bullet\;\: & \owraparr{2}{\functid{C}} &=&
                    \{\oarrid{2}{f}\mid\oarr{n}{f}=\oarrid{n}{o}\in\ccarr{C} \\[3pt]
                    &\text{or}&&
                       \oarr{n}{f}\in\wrapobj{\functid{C}}\,\}
 \end{array}
\end{equation*}
\end{definition}
...
Hence for any arrow, $\oarr{n}{f}\in\pazocal{C}$,
...
likewise for any arrow, $\oarr{n}{f}\in\pazocal{C}$,
...
\begin{equation*}
  \wrpobj{\ccpair{C}}=\{\nprojection{1}(\oarr{n}{f})\mid\oarr{n}{f}\in\catarr{C}\}
\end{equation*}
\end{definition}
...
\begin{equation*}
  \begin{array}{rl}
    \carrobj{C}\cpair{a}{b}=\{\oarr{n}{f}\mid&
                          \oarr{n}{f}\in\catarr{C}\quad\text{and} \\[3pt]
    \quad&\cpair{a}{b}=\nprojection{1}\,\oarr{n}{f}\}
  \end{array}
\end{equation*}
\end{definition}
...
$\oarrid{n}{\cpair{a}{b}}$, to identify objects of the collection, $\carrobj{C}$,

\begin{equation*}
\begin{gathered}
  \forall\;\cpair{a}{b}\in\wrpobj{\ccpair{C}}\quad
  \oarrid{n}{\cpair{a}{b}}=\fpair{\oarrid{n}{a}}{\oarrid{n}{b}}\in\wrparr{\ccpair{C}}\\[3pt]
   \text{where},\quad\obk{a},\,\obk{b}\in\ccobj{C}\quad\Rightarrow\quad
   \oarrid{n}{a},\,\oarrid{n}{b}\in\ccarr{C}
\end{gathered}
\end{equation*}
...
\begin{array}{rll}
  ...
  \oarr{n}{f},\,\oarr{n}{g}\in\ccarr{C}, \\[3pt]
\text{where}\quad&& \\[3pt]
  ...
  \oarr{n}{f}=\oarrpiop{1}{fst}{\farr{f}{g}},&&
  \oarr{n}{g}=\oarrpiop{1}{snd}{\farr{f}{g}}
\end{array}
\end{equation*}
...
\begin{equation}\label{eq:firstsecondindex}
  \begin{array}{rll}
  \oarr{n}{f}&=&\oarrpiop{1}{fst}{\farr{f}{g}} \\[3pt]
  \oarr{n}{g}&=&\oarrpiop{1}{snd}{\farr{f}{g}}
  \end{array}
\end{equation}

The identities, $\oarrid{n}{\cpair{a}{b}}$, are indexed by the collection,
$\wrpobj{\ccpair{C}}$, each instantiates a unique Hom object collection,
$\carrobj{C}$, from the category, $\pazocal{C}$:

\begin{equation*}
  \carrobj{C}\cpair{a}{b}=\oarrid{n}{\cpair{a}{b}}(\pazocal{C})
  \Longleftrightarrow\cpair{a}{b}
  \in\ccpair{C}
\end{equation*}
\begin{equation*}
  \carrobj{C}=\{\oarrid{n}{\cpair{a}{b}}(\pazocal{C})\mid
  \oarrid{n}{\cpair{a}{b}}\in\wrparr{\ccpair{C}}\}
\end{equation*}
...
\begin{array}{rlll}
  ...
  &\text{and}&&\oarr{n}{f},\,\oarr{n}{g}\in\catarr{C} \}
\end{array}
\end{equation*}
\begin{equation*}
\forall\quad\oarr{n}{\mu}\in\carrarr{C}\quad
...
$\oarr{n}{f}\in\carrobj{C}\cpair{a}{b}$, cannot be a member,
...
\begin{equation}
\begin{array}{rll}
\oarr{2}{\mu}&=&\ofarr{2}{\oarrid{n}{a}}{\arr{\mu}}, \\[3pt]
\oarrid{n}{a}&=&\oarrpiop{1}{fst}{\oarr{2}{\mu}}, \\[3pt]
...
\arr{g}=\arr{g}\circ\oarrid{n}{a}=\arr{\mu}\circ\arr{f}
\end{gathered}
\end{equation}
\end{theorem}
...
\begin{equation}
\begin{array}{rll}
\oarr{2}{\mu}&=&\ofarr{2}{\arr{\mu}}{\oarrid{n}{a}}, \\[3pt]
\arr{\mu}&=&\oarrpiop{1}{fst}{\oarr{2}{\mu}}, \\[3pt]
\oarrid{n}{a}&=&\oarrpiop{1}{snd}{\oarr{2}{\mu}}, \\[3pt]
\text{where}\quad&& \\[3pt]
...
reduces to,
\begin{equation}
\arr{f}\circ\arr{\mu}=\oarrid{n}{a}\circ\arr{g}=\arr{g}
\end{equation}
\end{corollary}
...
identity arrow, $\oarrid{n}{c}$. Of more consequence is that the identity
...
$\catobj{C/c}$ is the identity arrow $\oarrid{n}{c}$.
    
\begin{equation*}
   \arr{f}=\oarrid{n}{c}\circ\arr{f}\;
   \text{where}\;\oarrid{n}{c},\,\arr{f}\in\catobj{C/c}\lessdot\catarr{C/c}
\end{equation*}

Interestingly, this propery establishes $\oarrid{n}{c}$ as the domain object
...
\begin{equation*}
   \arr{f}=\arr{f}\circ\oarrid{n}{c}\;
   \text{where}\;\oarrid{n}{c},\,\arr{f}\in\catobj{c/C}\lessdot\catarr{c/C}
\end{equation*}

Interestingly, this propery establishes $\oarrid{n}{c}$ as the codomain object
...
\quad\bullet\quad&\wrpcarr{\singletoncat{c}}&=&\{\oarrid{n}{c}\}
\end{array}
\end{equation*}
\end{definition}
...
\begin{definition}{Relation class, $\mathcal{R}$}\label{def:relationclass},
  ...
  \item\textbf{(Strict)} \\[3pt]
    $\funct{R}(\carrobj{C}\cpair{a}{b})=\left\{\begin{array}{ll}
                                 ...
                                 \{\oarr{n}{R}\} &\text{relatable}
                                 \end{array}$ \\[3pt]
    where $\{\oarr{n}{R}\}$ is a singleton set.  \\[3pt]
    In shorthand
       \begin{equation*}
...
\begin{definition}{Partial Order}\label{def:relation},
  ...
  $\{\oarr{n}{k}\}\in\parsecat{C}_{\obk{R},\rightarrow,\subp{0}}$,
\begin{equation*}
  \{\oarr{n}{k}\}\cong\catN{1}\,,\quad\oarrdom{n}{k},\,\oarrcod{n}{k}\in\ccobj{C}
\end{equation*}
\end{definition}
...
\begin{definition}{Partial order subcategory},
  ...
  \begin{equation*}
  \begin{array}{rl}  
    \hspace{34pt}\wraparr{\ccrel{C}{\leq}}=\{\oarr{n}{\leq}\mid
    &\oarrdom{n}{\leq}=\obk{a}
           ,\,\oarrcod{n}{\leq}=\obk{b}, \\[3pt]
...
\begin{align*}
  \oarr{n}{r}\in\carrobj{C}\cpair{a}{b}\;\text{and}\;
  \oarr{n}{r}\in\carrobj{C}\cpair{a^{\prime}}{b^{\prime}} \\[3pt]
...
well from arrows, $\oarr{n}{h_{ij}}\in\ccarr{J}$, to arrows,
$\ofunct{\mathsf{D}}(\oarr{n}{h_{ij}})\in\ccarr{Z}$:

\begin{equation*}
\begin{array}{rll}
  \obk{i},\,\obk{j}&\in&\pazocal{J}, \\[3pt]
  \oarr{n}{h_{ij}}&\in&\carrobj{J}\cpair{i}{j}
\end{array}
\end{equation*}
\begin{equation*}
...
\begin{array}{rll}
  \obk{i},\,\obk{j}&\in&\pazocal{J}, \\[3pt]
  \oarr{n}{h_{ij}}&\in&\carrobj{J}\cpair{i}{j} \\[3pt]
  \oarr{n}{d_i},\,\oarr{n}{d_j}&\in&\wrparr{\funct{\mathsf{D},}}, \\[3pt]
  \oarr{2}{d_{ij}}&\in&\owrparr{2}{\funct{\mathsf{D},}} \\[3pt]
  \oarr{n}{d_i}(\obk{i}),\,\oarr{n}{d_j}(\obk{j})&\in&
           \wrpobj{\ofunct{\mathsf{D}}(\pazocal{J})}\lessdot\ccobj{Z}, \\[3pt]
  \oarr{2}{d_{ij}}(\oarr{n}{h_{ij}})&\in&\wrparr{\ofunct{\mathsf{D}}(\pazocal{J})}
                                      \lessdot\ccarr{Z}
\end{array}
\end{equation*}
where,
...
\begin{array}{rll}
  \obk{i},\,\obk{j}&\in&\pazocal{J}, \\[3pt]
  \oarr{n}{h_{ij}}&\in&\carrobj{J}\cpair{i}{j} \\[3pt]
  \oarr{n}{u_i},\,\oarr{n}{u_j}&\in&\wrparr{\ofunct{\pazocal{J}/{\obk{z}},}}, \\[3pt]
  \oarr{2}{u_{ij}}&\in&\owrparr{2}{\ofunct{\pazocal{J}/{\obk{z}},}} \\[3pt]
  \oarr{n}{u_i}(\obk{i}),\,\oarr{n}{u_j}(\obk{j})&=&\obk{z}\in
                       \wrpobj{\singletoncat{z,}}\lessdot\ccobj{Z}, \\[3pt]
  \oarr{2}{u_{ij}}(\oarr{n}{h_{ij}})&=&\oarrid{n}{z}\in
...
maps an domain arrow, $\oarr{n}{u_i}$, to a codomain arrow, $\oarr{n}{d_i}$:

\begin{equation*}
\begin{array}{rll}
  \oarr{2}{\lambda_i}&\in&\nfunct{\lambda_{z}}_{,\obk{2}} \\[3pt]
  \oarr{n}{u_i}&=&\oarrdom{2}{\lambda_i}\in
               \wrparr{\ofunct{\parsecat{J}/\obk{z}}} \\[3pt]
  \oarr{n}{d_i}&=&\oarrcod{2}{\lambda_i}\in\wrparr{\ofunct{\mathsf{D}}} \\[3pt]
\text{where},\quad&& \\[3pt]
  \obk{i}&=&\oarrdom{n}{u_i}=\oarrdom{n}{d_i}
\end{array}
\end{equation*}

Each arrow, $\oarr{n}{u_i}\in\wrparr{\ofunct{\parsecat{J}/\obk{z},}}$,
 share a common codomain object, $\obk{z}\in\pazocal{Z}$

\begin{equation*}
\begin{gathered}
  \oarr{n}{u_i}\in\wrparr{\ofunct{\parsecat{J}/\obk{z},}} \\[3pt]
  \mapaob{\obk{i}}{\obk{u_i}}{\obk{z}}
\end{gathered}
\end{equation*}

Each arrow, $\oarr{n}{d_i}\in\wrparr{\ofunct{\mathsf{D},}}$, embeds a diagram
object into the target category, $\pazocal{Z}$:

\begin{equation*}
\begin{gathered}
  \oarr{n}{d_i}\in\wrparr{\funct{\mathsf{D}}_,} \\[3pt]
  \mapaob{\obk{i}}{\obk{d_i}}{\mathsf{D}(\obk{i})}
\end{gathered}
\end{equation*}

Overall, each second order arrow, $\oarr{2}{\lambda_i}$ relates,
domain arrow, $\oarr{n}{u_i}$, to a codomain arrow, $\oarr{n}{d_i}$:
...
The domain/codomain pair, $\oarr{n}{u_i}$ and $\oarr{n}{d_i}$, of the second order
...
\begin{equation*}
\oarr{2}{\lambda_i}=
\fpair{\oarr{n}{\lambda_{\oper{fst},i}}}{\oarr{n}{\lambda_{\oper{snd},i}}}
\end{equation*}
...
The first arrow, $\oarr{n}{\lambda_{\oper{fst},i}}$, having identical domain/codomain,
$\obk{i}$, is equivalently and essentially the identity arrow, $\oarrid{n}{i}$,
in the construction, otherwise the theorem cannot be applied.

\begin{equation*}
\oarrid{n}{i}=\oarr{n}{\lambda_{\oper{fst},i}}
\end{equation*}

The second arrow, $\oarr{n}{\lambda_{\oper{snd},i}}$, with domain/codomain,
$\obk{z}$ and $\mathsf{D}(\obk{i})$ respectively, holds singular significance.

\begin{equation*}
\oarr{2}{\lambda_i}=
\fpair{\oarrid{n}{i}}{\oarr{n}{\lambda_{\oper{snd},i}}}
\end{equation*}
...
\end{equation*}
\begin{equation*}
\forall\oarr{n}{\lambda_i}\in\funct{\lambda_{\obk{z}}}\quad
...
$\oarr{2}{\lambda_i}$, share a common codomain, $\oarr{n}{d_i}$, diagram arrow,
...
common codomain, diagram arrows, $\oarr{n}{d_i}\in\wrparr{\ofunct{\mathsf{D},}}$,
...
\begin{equation}\label{eq:conelimittrans}
  \oarr{n}{\lambda^{\prime}_i}=\oarr{n}{\lambda_i}\circ\oarr{n}{\kappa^{\prime}_i}
\end{equation}
...
maps an domain arrow, $\oarr{n}{d_i}$, to a codomain arrow, $\oarr{n}{u_i}$:

\begin{equation*}
\begin{array}{rll}
  \oarr{2}{\lambda_i}&\in&\nfunct{\lambda_{z}}_{,\obk{2}} \\[3pt]
  \oarr{n}{d_i}&=&\oarrdom{2}{\lambda_i}\in
               \wrparr{\ofunct{\mathsf{D},}} \\[3pt]
  \oarr{n}{u_i}&=&\oarrcod{2}{\lambda_i}
...
Overall, each second order arrow, $\oarr{2}{\lambda_i}$ relates,
domain arrow, $\oarr{n}{d_i}$, to a codomain arrow, $\oarr{n}{u_i}$:
...
The domain/codomain pair, $\oarr{n}{d_i}$ and $\oarr{n}{u_i}$, of the second order
...
\begin{equation*}
\oarr{2}{\lambda_i}=
\fpair{\oarr{n}{\lambda_{\oper{dom},i}}}{\oarr{n}{\lambda_{\oper{cod},i}}}
\end{equation*}
...
The first arrow, $\oarr{n}{\lambda_{\oper{dom},i}}$, with identical domain/codomain,
$\obk{i}$, is equivalently and essentially the identity arrow, $\oarrid{n}{i}$,
in the construction, otherwise the theorem cannot be applied.

\begin{equation*}
\oarrid{n}{i}=\oarr{n}{\lambda_{\oper{dom},i}}
\end{equation*}

The second arrow, $\oarr{n}{\lambda_{\oper{cod},i}}$, with domain/codomain,
$\mathsf{D}(\obk{i})$ and $\obk{z}$ respectively, holds singular significance.

\begin{equation*}
\oarr{2}{\lambda_i}=
\fpair{\oarrid{n}{i}}{\oarr{n}{\lambda_{\oper{cod},i}}}
\end{equation*}
...
\end{equation*}
\begin{equation*}
\forall\;\obk{i}\in\ccobj{J},\,\oarr{n}{\lambda_i}\in\funct{\lambda_{\obk{z}}}
...
$\oarr{2}{\lambda^{\prime}_i}$, share a common domain, $\oarr{n}{d_i}$,
diagram arrow,
...
common domain, diagram arrows, $\oarr{n}{d_i}\in\wrparr{\ofunct{\mathsf{D},}}$,
...
\begin{equation}\label{eq:arrowcoconecolimitcompose}
  \oarr{n}{\lambda^{\prime}_i}=\oarr{n}{\kappa^{\prime}_i}\circ\oarr{n}{\lambda_i}
\end{equation}
...
with the property, $\oarr{n}{f}\circ\oarr{n}{e^{\prime}}=\oarr{n}{g}\circ\oarr{n}{e^{\prime}}$:
...
as the codomain of a collection arrows, $\oarr{n}{k^{\prime}}$,
each with a unique domain object, $\obk{z^{\prime}}\in\ccobj{P}$,

\begin{definition}{Equalizer},
  is an arrow, $\oarr{n}{e}$, identifying an equivalence subdomain for
  a pair of arrows, $\apair{f}{g}$, sharing
  the same domain and codomain objects, $\obk{a}$ and $\obk{b}$ respectively.
  \begin{equation*}
     \begin{gathered}
     \mapaob{z}{e}{a} \\
     \oarr{n}{e}(z)\lessdot\obk{a}=\oarrdom{n}{\fpair{f}{g}} \\
     \oarr{n}{f}\circ\oarr{n}{e}=\oarr{n}{g}\circ\oarr{n}{e}
    \end{gathered}
  \end{equation*}
  ...
  \begin{equation*}
     ...
     !\exists\oarr{n}{k^{\prime}}\in\ccarr{P} \\
     \obk{z^{\prime}}=\oarrdom{n}{k^{\prime}}\;\text{and}\;
     \obk{z}=\oarrcod{n}{k^{\prime}} \\
     \text{where}\;\oarr{n}{e^{\prime}}=\oarr{n}{e}\circ\oarr{n}{k^{\prime}}, \\
     \text{and}\;\oarr{n}{f}\circ\oarr{n}{e^{\prime}}=\oarr{n}{g}\circ\oarr{n}{e^{\prime}}
    \end{gathered}
  \end{equation*}
\end{definition}
...
$\oarr{n}{k^{\prime}}\in\ccarr{P}$, directed from domain objects in,
...
\begin{definition}{Subobject UMP, $\parsecat{Sub}$}, \label{def:subobject}
  ...
  \begin{equation*}
    \begin{array}{llll}
    \wrpobj{\subcat{C/c}}&=\{\oarrdom{n}{r}&\mid&\oarr{n}{r}\in\catobj{C/c}\} \\[3pt]
    \wrparr{\subcat{C/c}}&=\{\oarr{n}{r}&\mid&!\exists\,\oarr{n}{k^{\prime}},\,
                          \oarr{n}{k^{\prime}}=\oarrid{n}{o},\,\obk{o}\in\ccobj{P}\\[3pt]
      &\text{or}&&\oarr{n}{e^{\prime}}=\oarr{n}{e}\circ\oarr{n}{k^{\prime}}, \\[3pt]
      &&&\oarrcod{n}{e}=\oarrcod{n}{e^{\prime}}=\obk{a},\, \\[3pt]
      &&&\oarrcod{n}{k^{\prime}}=\oarrdom{n}{e}, \\[3pt]
      &&&\oarrdom{n}{k^{\prime}}=\oarrdom{n}{e^{\prime}}\}
  \end{array}
  \end{equation*}
  ...
  \begin{equation*}
  \begin{array}{lll}
    \wrpaobj{\subcat{C/c}}&=&\{\oarr{n}{r}\mid\oarrcod{n}{r}=\obk{c}\}\;
    \obk{c}\in\parsecat{c} \\[3pt]
           &&\{\oarrdom{n}{r}\mid\oarr{n}{r}\in\wrpobj{\subcat{C/c}}
  \end{array}
  \end{equation*}
  The subobject
...
The unique domains of preorder arrows, $\oarr{n}{r}\in\parsecat{C/c}$,
$\oarrdom{n}{r}$, provide a collection of objects f
...
To begin two objects, $\oarr{n}{f}$ and $\oarr{n}{g}$, are identified as
independent samples from a preorder, $\parsecat{P}$ with terminal
object, $\oarrid{n}{c}$, the identity arrow of $\obk{c}$.
Denote, $\obk{a}$ and $\obk{b}$, as the domains of arrows, $\oarr{n}{f}$ and
$\oarr{n}{g}$, respectively.
Independence is upheald by the application of arrows,
$\oarr{n}{f}$ and $\oarr{n}{g}$, enforciing the sample process.
...
projection arrows, $\oarr{n}{g_p}$ and  $\oarr{n}{f_p}$, to objects,
...
to arrow, $\oarr{n}{e_{zp}}$ and projections, $\oarr{n}{z_1}$ and $\oarr{n}{z_2}$, 
to objects, $\obk{a}$ and $\obk{b}$, respectively.

\begin{equation*}
\begin{array}{rll}
\obk{z}&\;\lessdot&\obk{p} \\[3pt]
\oarr{n}{z_1}=\oarr{n}{g_p}\circ\oarr{n}{e_{zp}}&\text{and}&
\oarr{n}{z_2}=\oarr{n}{f_p}\circ\oarr{n}{e_{zp}} \\[3pt]
\oarr{n}{z_1}(\obk{z})\lessdot\obk{a}&\text{and}&
\oarr{n}{z_2}(\obk{z})\lessdot\obk{b} \\[3pt]
...
collection of arrows, $\oarr{n}{e_{zp}}$. The preorder arrow
...
$\oarr{n}{\pi_1}=\oarr{n}{g_p}$
and $\oarr{n}{\pi_1}=\oarr{n}{g_p}$ projecting to objects,
...
\begin{figure}
    ...
    \end{tikzpicture}
      \caption{dashed arrow denotes the inference of an initial object,
        ...
        and arrows $\oarr{n}{e_{zp}}=\apair{z_1}{z_2}$ with 
        $\oarrcod{n}{e_{zp}}=\obk{a}\times\obk{b}$ and
        $\oarrdom{n}{e_{zp}}=\obk{z}$.}
        \label{fig:universalproduct}
\end{figure}

The distinct functor mapping of the triple,

$(\obk{a}\times\obk{b},\,\oarr{n}{\pi_1},\,\oarr{n}{\pi_2})$
...
\begin{definition}{Pair Projection}\label{def:pair},
  $\cpair{a}{b}$,
  $\obk{a}$, $\obk{b}$ are objects, $\oarr{n}{\pi_1}$. $\oarr{n}{\pi_2}$, are arrows:
\begin{equation*}
    \obk{a}=\oarr{n}{\pi_1}\cpair{a}{b}\quad\text{and}
    \quad\obk{b}=\oarr{n}{\pi_2}\cpair{a}{b}.
\end{equation*}
\end{definition}

Recalling the pair definition from $n-tuple$ functional designations,
$\oarr{n}{\pi_1}$ and $\oarr{n}{\pi_2}$,
...
\begin{center}
  $\oarr{n}{e_{zp}}=\apair{z_1}{z_2}$, \\[3pt]
  $\oarr{n}{z_1}=\oarr{n}{\g_p}\circ\oarr{n}{e_{zp}}\quad$ and
  $\quad\oarr{n}{z_2}=\oarr{n}{\f_p}\circ\funct{e_{zp}}$ \\[3pt]
...
\item$\wrpobj{\parsecat{C}\times\parsecat{D}}=
  ...
  \item$\wrparr{\parsecat{C}\times\parsecat{D}}=\{(\oarr{n}{f},\oarr{n}{h})\mid
    \oarr{n}{f}\in\catarr{C}\,\text{and}\,\oarr{n}{h}\in\catarr{D}\}$
  \begin{itemize}
  \item\textbf{(Domain)} \\
    $\qquad\qquad\qquad\oarrdom{n}{\fpair{f}{h}}=\cpair{\oarrdom{n}{f}}{\oarrdom{n}{g}}$
  \item\textbf{(Codomain)} $\oarrcod{n}{\fpair{f}{h}}=
    \cpair{\oarrcod{n}{f}}{\oarrcod{n}{g}}$
  \item\textbf{(Composition)} \\[3pt]
    $(\oarr{n}{f},\oarr{n}{h})\circ(\oarr{n}{f^\prime},
    \oarr{n}{h^\prime})=(\oarr{n}{f\circ f^\prime},\oarr{n}{h\circ h^\prime})$
  \item$\oarrid{n}{(\obk{a},\obk{b})}=(\oarrid{n}{a},\oarrid{n}{b})$
    $\forall\,(\obk{a},\obk{b})\in\wrpobj{\parsecat{C}\times\parsecat{D}}\quad$ \\[3pt]
  where $\oarrid{n}{a}\in\catarr{C}\quad\text{and}\quad\oarrid{n}{b}\in\catarr{D}$
  \end{itemize}
\end{itemize}
\end{definition}
...
and arrows depends of the definition of arrows, $\oarr{n}{\delta}$,
$\oarr{n}{\alpha}$, $\oarr{n}{f}$ and $\oarr{n}{g}$. The arrow, $\oarr{n}{\delta}$,
maps a domain set to a the diagonal pairs subset of $\obk{T}\times\obk{T}$.
The arrow, $\oarr{n}{f}$, characterizes a parameterized function
...
$\obk{t}\in\obk{T}$, such that $\oarr{n}{g}=\oarr{n}{f}\right_{\obk{t}}$.
...
\begin{equation*}\array{llll}
  ...
  \wrparr{\homcat}=\{&\oarr{n}{f}&\mid&\oarr{n}{f}\in\largecatarr \\[3pt]
...
\begin{definition}{Graph}\label{def:graph}, $\graph{G}$,
  ...
  Equivalently, there is a source arrow, $\oarr{n}{s}$,
  and a target arrow, $\oarr{n}{t}$, both originating
...
\begin{definition}{Walking Quiver}\label{def:walkingquiver},
  ...
  and $\wraparr{\wquiver{G}}=\{\oarr{n}{s},\,\oarr{n}{t},\,
  ...
  and $\graphe{G}$, respectively. $\oarr{n}{s}$ and $\oarr{n}{t}$
...
\graphv{G}=&\wrapobj{\forgetgrf{\parsecat{C}}}
               =\{\oarrid{n}{o}\mid\obk{o}\in\ccobj{C}\} \\[3pt]
  ...
  \{\oarr{n}{r}\mid\oarrdom{n}{r}=\obk{a},\;\oarrcod{n}{r}=\obk{b} \\[3pt]
  \quad&\hspace{24pt}\text{and}\;\oarr{n}{r}\neq\oarrid{n}{a}\} \\[3pt]
...
\begin{array}{lll}
  ...
  \ccarr{G}&=&
        \{\oarr{n}{s},\,\oarr{n}{t},\,\obk{id}_{\graphv{G}},\,\obk{id}_{\graphe{G}}\}
\end{array}
\end{equation*}
\begin{equation*}
    \begin{array}{ll}
      \quad\bullet\quad\textbf{(Source)}\quad\oarr{n}{s}(\graphe{G})=&
       \{\obk{v}\mid\obk{v}=\oarrdom{n}{f}, \\[3pt]
        \quad&\;\,\qquad\obk{v}\in\graphv{G},\,
         \oarr{n}{f}\in\graphe{G}\}\quad \\[3pt]
      \quad\bullet\quad\textbf{(Target)}\quad\oarr{n}{t}(\graphe{G})=&
       \{\obk{v}\mid\ovk{v}=\oarrcod{n}{f}, \\[3pt]
        \quad&\;\,\qquad\obk{v}\in\graphv{G},\,\oarr{n}{f}\in\graphe{G}\}
   \end{array}
\end{equation*}
...
\begin{array}{lll}
  ...
  \ccobj{G}&=&\{\graphv{G},\,\graphe{G}\} \\[3pt]
  \ccarr{G}&=&
  \{\arr{s},\,\oarr{n}{t},\,\oarr{n}{i},\,
               \obk{id}_{\graphv{G}},\,\obk{id}_{\graphe{G}}\} \\[3pt]
  \oarr{n}{i}&\thicksim&\text{arrow mapping from}\;\graphv{G}\; \\[3pt]
  \quad&\quad&\text{to identity arrow subcollection}\;
               \{\oarrid{n}{v}\mid\obk{v}\in\graphv{G}\}
\end{array}
\end{equation*}
\begin{equation*}
    \begin{array}{ll}
      ...
      \quad\bullet\quad\textbf{(Target)}\quad\oarr{n}{t}(\graphe{G})=&
       \{\obk{v}\mid\ovk{v}=\oarrcod{n}{f}, \\[3pt]
        \quad&\;\,\qquad\obk{v}\in\graphv{G},\,\oarr{n}{f}\in\graphe{G}\} \\[3pt]
      \quad\bullet\quad\textbf{(Reflex)}\quad\oarr{n}{i}(\graphv{G})=&
       \{\oarrid{n}{v}\mid
        \,\obk{v}\in\graphv{G},\,\oarrid{n}{v}\in\graphe{G}\}
   \end{array}
\end{equation*}
